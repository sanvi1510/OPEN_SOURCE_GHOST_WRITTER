...
WRITER_SYSTEM_PROMPT: str = (
    ...
    "- Code examples MUST NOT require any external third-party libraries (e.g. requests, numpy, pymupdf).\n"
    "  Only use Python standard library modules so the code runs in an isolated sandbox.\n"
...
WRITER_INITIAL_SYSTEM_PROMPT: str = (
    ...
    "- Code examples MUST NOT require any external third-party libraries.\n"
    "  Only use Python standard library modules so the code runs in an isolated sandbox.\n"
